...
public class PokemonTrainer {
	...
	public void getPokemonList() throws IOException, ClassNotFoundException {
		System.out.println("Request: LIST -- client");
		/*
		 * TODO
		 * Here you should write the request to the output stream.
		 */
		Request query = Request.LIST;
	...
	{
		System.out.println("Request: CLOSE -- client");
		/*
		 * TODO
		 * Here you should write the request to the output stream.
		 */
		Request query = Request.CLOSE;
		this.outputStream.writeObject(query);
